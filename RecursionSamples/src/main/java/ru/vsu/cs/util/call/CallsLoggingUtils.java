...
/**
 * Класс для логирования вызова методов
 */
public class CallsLoggingUtils {
    ...
    public static class MethodCall implements Iterable<MethodCall> {
        ...
        private static void toStringInner(StringBuilder sb, Object obj, int inner) {
            List list = null;
            try {
                list = (List) obj;
            ...
            if (obj == null) {
                ...
                if (inner > 1) {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        toStringInner(sb, Array.get(array, i), inner + 1);
                    }
                }
                if (inner > 0) {
                    sb.append(" }");
                ...
                if (inner > 1) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        toStringInner(sb, list.get(i), inner + 1);
                    }
                }
                if (inner > 0) {
                    sb.append(" }");
